 ...
 * 185 - Test Class
 *
 * This class provides a basic testing framework for the microservice 185. It was
...
public class Resource2Test {
  ...
  private static final ServiceNameVersion testTemplateService = new ServiceNameVersion(Resource2.class.getCanonicalName(),"0.1");

  private static final String mainPath = "res2";
  ...
  public void testpostSong() {
    ...
    try {
      JSONObject paylo = new JSONObject();
      c.setLogin(testAgent.getIdentifier(), testPass);
      ClientResponse result = c.sendRequest("GET", mainPath + "/song", paylo.toJSONString(),
